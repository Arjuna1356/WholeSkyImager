...
//        File imageFileHigh = new File(filePath+timeStamp+"-wahrsis" + wahrsisModelNr + "-high" + ".jpg");
        ...
        String photoMode = sharedPrefs.getString("scenePref", "preference_photo_mode_std");

        File imageFile;

        if(photoMode.equals("preference_photo_mode_std"))
        {
            imageFile = new File(filePath + timeStamp + "-wahrsis" + wahrsisModelNr + ".jpg");
        }
        else if(photoMode.equals("preference_photo_mode_dro"))
        {
            imageFile = new File(filePath + timeStamp + "-wahrsis" + wahrsisModelNr + "-DRO" + ".jpg");
        }
        else
        {
            imageFile = new File(filePath + timeStamp + "-wahrsis" + wahrsisModelNr + "-HDR" + ".jpg");
        }
