package sg.edu.ntu.wholeskyimagerex2.Preview;

import sg.edu.ntu.wholeskyimagerex2.MyDebug;
import sg.edu.ntu.wholeskyimagerex2.R;
import sg.edu.ntu.wholeskyimagerex2.TakePhoto;
import sg.edu.ntu.wholeskyimagerex2.CameraController.CameraController;
import sg.edu.ntu.wholeskyimagerex2.CameraController.CameraController1;
import sg.edu.ntu.wholeskyimagerex2.CameraController.CameraController2;
import sg.edu.ntu.wholeskyimagerex2.CameraController.CameraControllerException;
import sg.edu.ntu.wholeskyimagerex2.CameraController.CameraControllerManager;
import sg.edu.ntu.wholeskyimagerex2.CameraController.CameraControllerManager1;
import sg.edu.ntu.wholeskyimagerex2.CameraController.CameraControllerManager2;
import sg.edu.ntu.wholeskyimagerex2.Preview.ApplicationInterface.NoFreeStorageException;
import sg.edu.ntu.wholeskyimagerex2.Preview.CameraSurface.CameraSurface;
import sg.edu.ntu.wholeskyimagerex2.Preview.CameraSurface.MySurfaceView;
import sg.edu.ntu.wholeskyimagerex2.Preview.CameraSurface.MyTextureView;
...
//			}
    ...
    private CameraController openCameraCore(int cameraId)
    {
        ...
        try
        {
            ...
            if (using_android_l)
            {
                camera_controller_local = new CameraController2(Preview.this.getContext(), cameraId, cameraErrorCallback);
    ...
    private void setupCameraParameters()
    {
...

        {
            ...
            if (supported_flash_values != null && supported_flash_values.size() > 1)
            {
                ...
                String flash_value = "flash_off"; //applicationInterface.getFlashPref();
