package sg.edu.ntu.wholeskyimagerex2.CameraController;
...
public class CameraController2 extends CameraController {
	 ...
	 */
	public CameraController2(Context context, int cameraId, final ErrorCallback camera_error_cb) throws CameraControllerException {
		super(cameraId);
		if( MyDebug.LOG ) {
